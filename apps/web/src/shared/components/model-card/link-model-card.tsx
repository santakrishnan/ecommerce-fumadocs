...
export interface LinkModelCardProps extends ModelCardContentProps {
  className?: string;
...
/**
 * Navigable model card — wraps ModelCardContent in a LinkCard shell.
 * Server Component safe.
 */
export function LinkModelCard({
  className,
  linkProps,
  size = "search",
  surface = "dark",
