...
export interface LinkTrimCardProps extends TrimCardContentProps {
  className?: string;
...
/**
 * Navigable trim card — wraps TrimCardContent in a LinkCard shell.
 * Server Component safe.
 */
export function LinkTrimCard({
  className,
  linkProps,
  size = "search",
  surface = "dark",
