/**
 * Fixture data for LegalPage component tests
 */

import type { LegalPageProps } from "../legal-page";

export const mockLegalPageProps: LegalPageProps = {
...
export const minimalLegalPageProps: LegalPageProps = {
  title: "Legal Notice",
  sectionHeading: "Notice",
...
export const legalPageWithoutUpdatedLabel: Omit<LegalPageProps, "updatedLabel"> = {
  title: "Test Title",
